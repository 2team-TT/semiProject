...
/**
 * Servlet implementation class PropertyMain
 */
@WebServlet("/main.prop")
public class PropertyMain extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		currentPage = 1; // 화면 로드할 때 기본값으로 1
		detailLimit = 20;
		pageLimit = 10;
...
//		response.setContentType("text/html; charset=utf-8");
		request.getRequestDispatcher("views/property/propertyMain.jsp").forward(request, response);
