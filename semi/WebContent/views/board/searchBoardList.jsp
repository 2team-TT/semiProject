  ...
  <body>
    ...
    <section class="Board_list">
      ...
      <div class="page_area">
        ...
        <%}else{ %>
        <button
          onclick="location.href='<%=contextPath%>/freeBoardList.bo?cpage=<%= i%>'"
        >
          <%=i %>
        </button>
    ...
    <script>
      const free_choose_board = document.querySelector(
        ".board_navi .navi_content>.free_choose_board"
      );

      const honey_choose_board = document.querySelector(
        ".board_navi .navi_content .honey_choose_board"
      );
      const cook_choose_board = document.querySelector(
        ".board_navi .navi_content .cook_choose_board"
      );
      const used_choose_board = document.querySelector(
        ".board_navi .navi_content .used_choose_board"
      );
      ...
      $(function () {
        $(".board_table tr").on("click", function () {
          ...
          location.href =
            "<%=contextPath%>/boardDeteil.bo?bno=" +
